...
# -*- coding: utf-8 -*-
#
# kripo documentation build configuration file, created by
...
project = u'Kripo'
copyright = u"2017, Nederlands eScience Center"
...
version = kripo.__version__
# The full version, including alpha/beta/rc tags.
release = kripo.__version__
...
intersphinx_mapping = {'https://docs.python.org/': None,
                       'kripodb': ('http://kripodb.readthedocs.org/en/latest/', None),
                       'atomium': ('https://atomium.samireland.com/', None),
